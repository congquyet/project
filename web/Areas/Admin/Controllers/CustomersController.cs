...
namespace project.Areas.Admin.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public IActionResult Index(int? page)
        {
            ...
            //cach 2
            List<ItemCustomer> list_Customers = (from item in db.Customers orderby item.Id descending select item).ToList();
        ...
        public IActionResult UpdatePost(int? id, IFormCollection fc)
        {
            ...
            string _Address = Request.Form["Address"].ToString().Trim();
            string _Phone = Request.Form["Phone"].ToString().Trim();
